 ...
 *
 */
public class ReassignUserApplicationResponse implements Serializable{
	...
	private String securityReleaseNum;
	...
	/**
	 * @return the securityReleaseNum
	 */
	public String getSecurityReleaseNum() {
		return securityReleaseNum;
	}

	/**
	 * @param securityReleaseNum the securityReleaseNum to set
	 */
	public void setSecurityReleaseNum(String securityReleaseNum) {
		this.securityReleaseNum = securityReleaseNum;
	}
