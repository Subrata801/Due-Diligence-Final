...
import com.bankMitra.model.bankenduserpanel.response.ReassignUserApplicationM3Response;
import com.bankMitra.model.bankenduserpanel.response.ReassignUserApplicationResponse;

import java.sql.ResultSet;
import java.sql.SQLException;

public class ReAssignUserM3RowMapper implements RowMapper<ReassignUserApplicationResponse> {

    public ReassignUserApplicationResponse mapRow(ResultSet rs, int rowNum) throws SQLException {

    	ReassignUserApplicationM3Response userApplicationResponse = new ReassignUserApplicationM3Response();
