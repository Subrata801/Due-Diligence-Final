...
import com.bankMitra.model.bankenduserpanel.response.ReassignUserApplicationM2Response;
import com.bankMitra.model.bankenduserpanel.response.ReassignUserApplicationResponse;

import java.sql.ResultSet;
import java.sql.SQLException;

public class ReAssignUserM2RowMapper implements RowMapper<ReassignUserApplicationResponse> {

    public ReassignUserApplicationResponse mapRow(ResultSet rs, int rowNum) throws SQLException {

    	ReassignUserApplicationM2Response userApplicationResponse = new ReassignUserApplicationM2Response();
