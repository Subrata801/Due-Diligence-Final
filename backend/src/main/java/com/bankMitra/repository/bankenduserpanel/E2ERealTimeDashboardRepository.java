 ...
 *
 */
public interface E2ERealTimeDashboardRepository {
	...
	E2ERealTimeDashboardResponse getDashBoardHeaders(E2ERealTimeDashboardRequest e2eDashboardRequest) throws DataAccessException;
