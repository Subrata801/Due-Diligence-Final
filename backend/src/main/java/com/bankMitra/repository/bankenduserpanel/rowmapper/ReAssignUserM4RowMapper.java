...
import com.bankMitra.model.bankenduserpanel.response.ReassignUserApplicationM4Response;
import com.bankMitra.model.bankenduserpanel.response.ReassignUserApplicationResponse;

import java.sql.ResultSet;
import java.sql.SQLException;

public class ReAssignUserM4RowMapper implements RowMapper<ReassignUserApplicationResponse> {

    public ReassignUserApplicationResponse mapRow(ResultSet rs, int rowNum) throws SQLException {

    	ReassignUserApplicationM4Response userApplicationResponse = new ReassignUserApplicationM4Response();
